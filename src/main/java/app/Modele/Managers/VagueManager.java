...
public class VagueManager {
    ...
    private static TreeMap<Integer, List<Animal>> v1(GameWorld w, int diffficulte) {
    ...
    private static TreeMap<Integer, List<Animal>> v2(GameWorld w, int diffficulte) {
    ...
    private static TreeMap<Integer, List<Animal>> v3(GameWorld w, int diffficulte) {
    ...
    private static TreeMap<Integer,List<Animal>> v4(GameWorld w, int diffficulte) {
    ...
    private static TreeMap<Integer, List<Animal>> v5(GameWorld w, int diffficulte) {
    ...
    private static TreeMap<Integer, List<Animal>> v6(GameWorld w, int diffficulte) {
    ...
    private static TreeMap<Integer, List<Animal>> v7(GameWorld w, int diffficulte) {
    ...
    public static List<TreeMap<Integer, List<Animal>>> ensembleVagues (GameWorld w, int diffficulte){
        List<TreeMap<Integer, List<Animal>>> v= new ArrayList<>();

        v.add(v1(w, diffficulte));     // 0+20 =20
        v.add(v2(w, diffficulte));    // ( +10 = 30) + 20 = 50
        v.add(v3(w, diffficulte));    // ( +10 = 60) + 15 = 75
        v.add(v4(w, diffficulte));    // ( +10 = 85) + 15 = 100
        v.add(v5(w, diffficulte));   // ( +10 = 110) + 20 = 130
        v.add(v6(w, diffficulte));
