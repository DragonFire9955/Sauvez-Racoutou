...
public class ImageSetter {
    ...
    public static Image tonneau = new Image(ImageSetter.class.getResourceAsStream("/app/images/herbe.png"), 32, 32, true, true);
    ...
    public static Image classique = new Image(ImageSetter.class.getResourceAsStream("/app/images/classique.png"), 32, 32, false, true);
